...
class _LoginPageState extends State<LoginPage> {
  ...
  Future<void> _login() async {
    ...
    var loginurl = Uri.parse('http://34.64.173.65:8080/login');
  ...
  Future<String> loadBarcodeImage(int userId) async {
    var response = await http.get(Uri.parse('http://34.64.173.65:8080/b/$userId'));
    if (response.statusCode == 200) {
  ...
  Future<String> fetchUserStatus(int userId) async {
    var response = await http.get(
        Uri.parse('http://34.64.173.65:8080/userstatus/$userId'));
    if (response.statusCode == 200) {

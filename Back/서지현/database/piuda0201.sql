...
CREATE TABLE `book` (
  ...
  `book_description` varchar(5000) DEFAULT NULL,
  `book_series` varchar(50) DEFAULT NULL,
  `field_name` varchar(50) NOT NULL,
  `book_id` varchar(100) NOT NULL,
  `book_ii` varchar(100) DEFAULT NULL,
...
INSERT INTO `userinterestbook` VALUES (10,2,'AMA000192817');
...
INSERT INTO `users` VALUES (1,'서지현','정상','https://piudabucket.s3.ap-southeast-2.amazonaws.com/11103524002214.jpg'),(2,'sw','정상','barcode2'),(4,'dfs','sdfs','f'),(11103524002214,'서지현','정상','https://piudabucket.s3.ap-southeast-2.amazonaws.com/11103524002214.jpg');
...
-- Dump completed on 2024-02-01  8:19:45
